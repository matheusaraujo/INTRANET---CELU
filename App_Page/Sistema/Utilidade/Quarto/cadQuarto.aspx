<!--
    INTRANET CELU
    App_Page/Sistema/Utilidade/Quarto/cadQuarto.aspx
    Página de cadastro de Quarto
    # 2011-02-05
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadQuarto.aspx.cs" Inherits="App_Page_Sistema_Utilidade_Quarto_cadQuarto" %>
    ...
    <div>
        ...
        <table align="center" width="60%">
            <tr>                
                ...
                <td><input type="button" value="Buscar" id="btnFind" runat="server" onclick="javascript:window.navigate('listQuarto.aspx');"/></td>
            </tr>
        </table>
