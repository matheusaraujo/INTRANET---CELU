<!--
    INTRANET CELU
    App_Page/Sistema/Utilidade/StatusMorador/cadStatusMorador.aspx
    Página de cadastro de Status de Morador
    # 2011-02-04
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadStatusMorador.aspx.cs" Inherits="App_Page_Sistema_Utilidade_StatusMorador_cadStatusMorador" %>
...
<body>
    ...
    <div>
        <h1>Cadastro de Status de Morador</h1>
        <br />
        ...
        <table id="tblCadastro" runat="server" align="center" width="60%">
            ...
            <!-- Descrição -->
            <tr>
                <td align="right">Status de Morador:&nbsp;</td>                
        ...
        <table align="center" width="60%">
            <tr>                
                ...
                <td><input type="button" value="Buscar" id="btnFind" runat="server" onclick="javascript:window.navigate('listStatusMorador.aspx');"/></td>
            </tr>
        </table>
