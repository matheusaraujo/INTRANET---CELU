<!--
    INTRANET CELU
    App_Page/Sistema/Utilidade/Curso/cadCurso.aspx
    Página de cadastro de Curso
    # 2011-02-05
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadCurso.aspx.cs" Inherits="App_Page_Sistema_Utilidade_StatusMorador_cadStatusMorador" %>
    ...
    <div>
        ...
        <table align="center" width="60%">
            <tr>                
                ...
                <td><input type="button" value="Buscar" id="btnFind" runat="server" onclick="javascript:window.navigate('listCurso.aspx');"/></td>
            </tr>
        </table>
