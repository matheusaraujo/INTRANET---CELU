<!--
    INTRANET CELU
    App_Page/Sistema/Utilidade/Cidade/cadCidade.aspx
    Página de cadastro de Cidade
    # 2011-02-05
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadCidade.aspx.cs" Inherits="App_Page_Sistema_Utilidade_Cidade_cadCidade" %>
    ...
    <div>
        ...
        <table align="center" width="60%">
            <tr>                
                ...
                <td><input type="button" value="Buscar" id="btnFind" runat="server" onclick="javascript:window.navigate('listCidade.aspx');"/></td>
            </tr>
        </table>
