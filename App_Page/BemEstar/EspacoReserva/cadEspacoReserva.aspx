<!--
    INTRANET CELU
    App_Page/BemEstar/EspacoReserva/cadEspacoReserva.aspx
    Página de cadastro de Espaço de Reserva
    # 2012-03-21
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadEspacoReserva.aspx.cs" Inherits="App_Page_BemEstar_EspacoReserva_cadEspacoReserva" %>
    ...
    <div>
        ...
        <table align="center" width="60%">
            <tr>                
                ...
                <td><input type="button" value="Buscar" id="btnFind" runat="server" onclick="javascript:window.navigate('listEspacoReserva.aspx');"/></td>
            </tr>
        </table>
