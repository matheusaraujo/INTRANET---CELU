<!--
    INTRANET CELU
    App_Page/BemEstar/StatusReserva/cadStatusReserva.aspx
    Página de cadastro de Status de Reserva
    # 2012-03-21
    Matheus Araújo
-->

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadStatusReserva.aspx.cs" Inherits="App_Page_BemEstar_StatusReserva_cadStatusReserva" %>
...
<body>
    ...
    <div>
        ...
        <table id="tblCadastro" runat="server" align="center" width="60%">
            ...
            <!-- Descrição -->
            <tr>
                <td align="right">Status de Reserva:&nbsp;</td>                
