/***************************************************
 * INTRANET CELU
 * App_Page/Avisos/Recado/viewRecado.aspx.cs
 * Lista de recados
 * # 2011-04-09
 * Matheus Araújo 
 ***************************************************/
...
public partial class App_Page_Avisos_viewRecado : Celu.Library.WebPage.CPage
{
    ...
    public override Boolean loadPage()
    {
        ...
        String id = getUrlParameter(this.Request.RawUrl, "recado");
        ...
        else
        {
            ...
            CQuery query = db.select("EXECUTE LOAD_REG_RECADO " + id, "CHR_NOME;DT_DATAHORA;CHR_DESC_TIPO_RECADO;CHR_RECADO");
